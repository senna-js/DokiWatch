        ...
        >
          ...
          <div className="relative z-10">
            ...
            <Routes>
              ...
              <Route path="/watching" element={<AnimeList title="Watching" list="watching" />} />
              <Route path="/completed" element={<AnimeList title="Completed" list="completed" />} />
              <Route path="/plan-to-watch" element={<AnimeList title="Plan to Watch" list="planToWatch" />} />
