        ...
        <div className="flex flex-col gap-6 mx-24 my-6">
            ...
            <div className="flex gap-4">
                <div className="relative group">
                    <img src={animeData?.images.jpg.large_image_url} alt={animeData?.title} className="block rounded-lg shadow-xl mx-auto my-2 w-full h-auto object-cover" />
