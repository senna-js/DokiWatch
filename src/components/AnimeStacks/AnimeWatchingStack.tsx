      ...
      <div className="p-3 m-7 sm:m-0 rounded-[16px] sm:rounded-none bg-doki-light-grey backdrop-blur-lg">
        <h2 className="text-2xl sm:text-4xl font-lato text-doki-purple pl-3 flex items-center">
          ...
          <span className="flex items-center ml-2">
            ...
            <p className="text-base text-doki-purple font-bold font-poppins text-opacity-50">Aired</p>
          </span>
        </h2>
        <hr className="border border-doki-purple my-4" />
        <div className="relative overflow-hidden">
          {animeData && animeData.length > 0 ? (
            <div className="flex gap-2 overflow-x-auto overflow-y-hidden" ref={carouselRef}>
              {animeData.map((anime) => (
